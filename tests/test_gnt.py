...
def deploy_contract_and_accounts(state, n_devs, start=2, end=2, deploy_contract=True):
    dev_keys = []
    dev_accounts = []
    ...
    if deploy_contract:
        ...
        allocation = tester.ABIContract(state, ALLOC_ABI, contract.lockedAllocation())
    else:
